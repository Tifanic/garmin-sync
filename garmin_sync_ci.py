  ...
  - COM: uses garminconnect library
  - CN: uses garth library with garmin.cn domain
  - Upload to CN: uses httpx directly
  """
  ...
  def login_cn_with_garth(email: str, password: str) -> dict:
